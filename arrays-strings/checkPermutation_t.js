...
exports.checkPermutation2 = checkPermutation2 =function(str1, str2) {
  ...
  for (var i = 0; i < str1.length; i++) {
    if (hash1[str1.charAt(i)] === undefined)  hash1[str1.charAt(i)] = 1;
    else hash1[str1.charAt(i)] += 1;
    if (hash2[str2.charAt(i)] === undefined)  hash2[str2.charAt(i)] = 1;
    else hash2[str2.charAt(i)] += 1;
  }
  for (char in hash1) {
